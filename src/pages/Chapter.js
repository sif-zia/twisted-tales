                  ...
                  <div className="row justify-content-center">
                    <div className="col-lg-10">
                      ...
                      <p className="second-para">
                        ...
                        volutpat mi velit, ateng maximus est eleifend accui
                        Fusce porttitor ex arcu. Phasellus viverra lorem a nibh
                        placerat tincidunt.bolgotai Aliquam andit rutrum
                        elementum urna, vel fringilla tellus varius ut. Morbi
                        non velit odio.
                      </p>
                      <blockquote className="text-center">
                        <p className="blockquote-text">
                          "I work with Alguneb Johnl on many projects, he always
                          toldagona exceeds my expectations with his quality
                          work and fastestopa tope service, very smooth and
                      ...
                      <div className="col-lg-12">
                        ...
                        <p>
                          ...
                          facilisis. Nunc posuere at augue eget portat Inei odio
                          tellus, dignissim fermentumara purus nec, consequat
                          dapibus metus.Vivamus one urna worlda mauris, faucibus
                          at egestas quis, fermentum egetonav neque.
                        </p>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="col-lg-3 p-lg-0" style={{ marginTop: "50px" }}>
                  <div className="author-sidebar">
                    ...
                    <div className="author-sidebar-content">
                      <div className="author-title">
                        <h5>
                          <a href="author-details.html">Ericol Patrick</a>
                        </h5>
                        <span>Creative</span>
                      </div>
